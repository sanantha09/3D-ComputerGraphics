...
bool TeapotNode::Initialise()
{
	...
	ComputeTeapot(vertices, indices, 5.0f);

	BuildTeapotVertexNormals(vertices, indices);

	BuildTeapotGeometryBuffers();
	BuildTeapotShaders();
	BuildTeapotVertexLayout();
	BuildTeapotConstantBuffer();
...
void TeapotNode::Render()
{
	...
	constantBuffer.MaterialColour = Vector4(0.75f, 0.75f, 0.75f, 0.75f);
	constantBuffer.AmbientLightColour = _ambientColour;

	constantBuffer.DirectionalLightVector = Vector4(-1.0f, -1.0f, 1.0f, 0.0f);
	constantBuffer.DirectionalLightColour = Vector4(Colors::Violet);
...
void TeapotNode::BuildTeapotGeometryBuffers()
{
...
void TeapotNode::BuildTeapotShaders()
{
...
void TeapotNode::BuildTeapotVertexLayout()
{
...
void TeapotNode::BuildTeapotConstantBuffer()
{
...
void TeapotNode::BuildTeapotVertexNormals(vector<ObjectVertexStruct>& vertices, vector<UINT>& indices)
{
